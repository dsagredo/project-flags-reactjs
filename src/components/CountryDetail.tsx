...
;	
	const renderDetail = ({name, flags, population, region, subregion, capital, tld}: CountryAPI) => (
		<>
			...
			<div className="container flex mx-auto p-8 pl-0 pr-0 dark:text-white">
				<img src={flags.svg} className="rounded-2xl w-1/2" alt={name.common} />
				<div className="p-8 pl-8">
					...
					<div className="grid grid-cols-2 gap-x-20 gap-y-4">
						...
						<p>Top Level Domain: <span className="dark:text-gray-400 text-gray-700 text-sm">{tld}</span></p>
					</div>
				</div>
			</div>
		</>
